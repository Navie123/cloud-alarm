...
void connectWiFiManager() {
  ...
  const char* customCSS = "<style>"
    ...
    "@keyframes glow { 0%,100% { text-shadow:0 0 8px rgba(255,107,53,0.6); } 50% { text-shadow:0 0 20px rgba(255,140,66,0.9); } }"
    ...
    ".c { text-align:center; margin-bottom:16px; }"
    ...
    /* ── Misc ── */
    "input[type='checkbox'] { margin-right:8px; transform:scale(1.2); accent-color:#ff6b35; }"

    "hr { border:none; height:1px; background:#1e2a3a; margin:20px 0; }"
    ...
    "document.addEventListener('DOMContentLoaded',function(){"
      ...
      "if(w){"
        ...
        "hdr.innerHTML='<div class=\"fw-logo\">&#128293; FireWire</div>"
          "<div class=\"fw-tagline\">Smart Fire &amp; Gas Alarm System</div>"
          "<div class=\"fw-badge\">WiFi Setup Mode</div>';"
        "w.insertBefore(hdr,w.firstChild);"
        /* Steps guide */
        "var steps=document.createElement('div');"
        "steps.className='steps';"
        "steps.innerHTML="
          "'<div class=\"step\"><div class=\"step-num\">1</div><div class=\"step-text\">Connect to<br><b>FireWire-Setup</b></div></div>"
          "<div class=\"step-divider\"></div>"
          "<div class=\"step\"><div class=\"step-num\">2</div><div class=\"step-text\">Pick your<br>home WiFi</div></div>"
          "<div class=\"step-divider\"></div>"
          "<div class=\"step\"><div class=\"step-num\">3</div><div class=\"step-text\">Enter<br>password</div></div>"
          "<div class=\"step-divider\"></div>"
          "<div class=\"step\"><div class=\"step-num\">4</div><div class=\"step-text\">Device<br>restarts</div></div>';"
        "w.insertBefore(steps,w.children[1]);"
      "}"
      /* Style network items */
      "document.querySelectorAll('.q').forEach(function(q){"
        "var lock=q.querySelector('.l');"
        "if(lock&&lock.textContent){"
          "var icon=document.createElement('span');"
          "icon.style.cssText='margin-right:8px;font-size:1.1em;';"
          "icon.textContent='\\uD83D\\uDCF6 ';"
          "lock.prepend(icon);"
        "}"
      "});"
      /* Add tip to password form */
      "var forms=document.querySelectorAll('form');"
      "forms.forEach(function(f){"
        "var tip=document.createElement('div');"
        "tip.className='tip';"
        "tip.innerHTML='<strong>Tip:</strong> Make sure you are connecting to your home WiFi, not a mobile hotspot. The device needs a stable connection.';"
        "f.appendChild(tip);"
      "});"
    "});"
    "</script>";
